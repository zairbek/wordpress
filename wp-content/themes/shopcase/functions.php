<?php
/**
 * shopcase functions and definitions
 *
...
if ( ! function_exists( 'shopcase_setup' ) ) :
	/**
	 ...
	 */
	function shopcase_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on shopcase, use a find and replace
		 * to change 'shopcase' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'shopcase', get_template_directory() . '/languages' );
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'shopcase_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'shopcase_setup' );
 ...
 */
function shopcase_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'shopcase_content_width', 640 );
}
add_action( 'after_setup_theme', 'shopcase_content_width', 0 );
 ...
 */
function shopcase_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'shopcase' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'shopcase' ),
...
add_action( 'widgets_init', 'shopcase_widgets_init' );
...
function shopcase_scripts() {
	...
	wp_enqueue_style( 'shopcase-component', get_template_directory_uri() . '/layouts/component.css' );
	...
	wp_enqueue_script( 'cbpBGSlideshow', get_template_directory_uri() . '/js/libs/cbpBGSlideshow.js', array(), '', true );
	wp_enqueue_script( 'jquery.imagesloaded', get_template_directory_uri() . '/js/libs/jquery.imagesloaded.min.js', array(), '', false );
	wp_enqueue_script( 'shopcase-scripts', get_template_directory_uri() . '/js/script.js', array(), '', true );

	wp_enqueue_script( 'shopcase-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );

	wp_enqueue_script( 'shopcase-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), _S_VERSION, true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'shopcase_scripts' );
